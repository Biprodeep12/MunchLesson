    ...
    <div className='min-h-screen px-4 py-8 bg-gradient-to-br from-[#FFDEE9] to-[#B5FFFC] '>
      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='bg-white rounded-2xl shadow-2xl overflow-hidden'>
          <div className='grid grid-cols-3 sm:grid-cols-4 bg-gradient-to-r from-[#FF6B6B] to-[#FFD166] p-4 text-sm font-bold text-gray-700 text-center'>
            <div>Rank</div>
            <div>Player</div>
            <div>XP</div>
          ...
          {!loading &&
            players.map((player, index) => (
              <div
                key={player.uid}
                className={`grid grid-cols-3 sm:grid-cols-4 p-4 border-b transition-all duration-300 hover:bg-gray-50 ${
                  index < 3
                ...
                <div className='flex items-center gap-4'>
                  <Image
                    ...
                    src={player.photo}
                    alt={player.name}
                    className='w-14 h-14 rounded-full border-4 border-white shadow-lg object-cover hidden sm:block'
                  />
                ...
                <div className='text-orange-500 font-semibold flex justify-center'>
                  {player.score * 10} XP
                </div>

                <div className='text-md text-blue-700 bg-blue-100 px-4 py-2 rounded-full w-fit font-semibold  hidden sm:block place-self-center'>
